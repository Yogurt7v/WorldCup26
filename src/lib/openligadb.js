...
const LABELS = {
  r32: ['A01','A02','A03','A04','A05','A06','A07','A08','A09','A10','A11','A12','A13','A14','A15','A16'],
    ...
    try {
      ...
      for (const stage of stageOrder) {
        ...
        const matches = stageGames.map((g, i) => {
          const homeTeam = g.home_team_name_en ? translateTeamName(g.home_team_name_en) : null
          const awayTeam = g.away_team_name_en ? translateTeamName(g.away_team_name_en) : null
          ...
          return {
            ...
            home_team: homeTeam,
            away_team: awayTeam,
            home_score: g.finished === 'TRUE' && g.home_score != null ? parseInt(g.home_score, 10) : null,
            away_score: g.finished === 'TRUE' && g.away_score != null ? parseInt(g.away_score, 10) : null,
      ...
      if (r32Col) r32Col.label = '1/32 финала'
